...
QVariantList DBOP::listSessionMessages(int sessionId)
{
	static const QString SESSION_MESSAGE_GET_ALL("select * from Message where sid=?");
	...
	qDebug() << "session message select all success";
	return result;
}
